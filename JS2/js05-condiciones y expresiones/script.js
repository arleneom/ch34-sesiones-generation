...
/* ======================Operadores de comparacion=================
    ...
    Comparan sus operandos y devuelven un valor booleano 
    ...
    Estos comparadores realizan una conversion implicita a numeros cuando los operados son diferente tipo de dato.

    <, >, >=, <= se compara caracter por caracter con su valor númerico de la tabla unicode. 
*/
...
/*
Cuando los operadores logicos AND y OR actuan sobre operandos
diferentes a booleanos.

OP1 && OP2 -> Si OP1 es verdadero, se realiza la OP2 y este seria el resultado (OP2)
OP1 || OP2 -> Si OP1 es verdadero, el resultado es OP1, no se evalua OP2

Se concidera false, debe ser: "", 0, NaN, null, undefined
*/
