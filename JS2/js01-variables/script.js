...
// indice del objeto de numero de canciones del anio 2020
console.log("canciones por anio 2020: " + cancionesPesoPluma[5]["2020"]); // 5

// mostrar el "total de canciones de PP"
console.log("Total de camciones: " + cancionesPesoPluma[5]["total"]);
console.log("Total de camciones: " + cancionesPesoPluma[5].total);
...
console.log( parseInt("3 MxM") ); // 3
console.log( Number("3 MxM") ); // NaN

console.log("$3MNX" + 5 + 6 ) //
